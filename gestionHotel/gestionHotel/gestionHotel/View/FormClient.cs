...
namespace gestionHotel.View
{
    public partial class FormClient : Form
    {
        ...
        {
            int clientel = clientController.Enregistrer(textBox_nom.Text, textBox_prenom.Text, textBox_adresse.Text, comboBox_genre.Text, comboBox_status.Text, int.Parse(textBox_tel.Text));
